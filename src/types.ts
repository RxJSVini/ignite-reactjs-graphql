...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, description?: string | null, title: string, lessonType: LessonType, slug?: string | null, availableAt?: any | null, videoId: string }> };
